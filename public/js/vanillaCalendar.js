...
var vanillaCalendar = {
    ...
    createDay: function(t, e, a) {
        ...
        n.setAttribute("data-calendar-status", "active")), this.date.toString() === this.todaysDate.toString() && n.classList.add("vcal-date--today"),
        n.appendChild(s),
    ...
    dateClicked: function() {
        ...
        for (var e = 0; e < this.activeDates.length; e++)
            ...
            myDay = this.dataset.calendarDate[0]+this.dataset.calendarDate[1]+this.dataset.calendarDate[2];
            selectDate = [myDay,this.textContent,myMonth,myYear];
            dateTimeDetail = this.dataset.calendarDate;
            t.removeActiveClass();
    ...
    createMonth: function() {
        ...
        for (var t = this.date.getMonth(); this.date.getMonth() === t;) this.createDay(this.date.getDate(), this.date.getDay(), this.date.getFullYear()),
