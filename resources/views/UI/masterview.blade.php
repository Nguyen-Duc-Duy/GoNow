							...
							<ul>
								...
								<li class="type-1"><a href="#">Hotels<span class="fa fa-angle-down"></span></a>
									<ul class="dropmenu">
										...
										<li><a href="{{route('hotel')}}">List View</a></li>
					...
					<div class="footer-block">
						...
						<div class="f_news clearfix">
							<a class="f_news-img black-hover" href="#">
								<img class="img-responsive" src="{{ asset('public/images/home_6/news_1.jpg')}}" alt="">
						...
						<div class="f_news clearfix">
							<a class="f_news-img black-hover" href="#">
								<img class="img-responsive" src="{{ asset('public/images/home_6/news_2.jpg')}}" alt="">
								<div class="tour-layer delay-1"></div>
							</a>
							<div class="f_news-content">
								<a class="f_news-tilte color-white link-red" href="#">amazing place</a>
